...
for thread in $(seq 1 5); do
    ...
    for run in $(seq 1 1); do
        ...
        $EXECUTABLE -p 1,4,5,6,3 -n $thread -f 2 -r 100 -i 4096 -t 0
...
for thread in $(seq 1 5); do
    ...
    for run in $(seq 1 1); do
        ...
        sleep 20
        EXECUTABLE=/users/bbritto/workspace/uFS/cfs/build/test/client-retry/workload/webserver
        $EXECUTABLE -p 1,4,5,6,3 -n $thread -f 2 -r 100 -i 4096 -t 3
...
for thread in $(seq 1 5); do
    ...
    for run in $(seq 1 1); do
        ...
        sleep 20
        EXECUTABLE=/users/bbritto/workspace/uFS/cfs/build/test/client-retry/workload/webserver
        $EXECUTABLE -p 1,4,5,6,3 -n $thread -f 2 -r 100 -w 100 -i 4096 -t 1
...
for thread in $(seq 1 5); do
    ...
    for run in $(seq 1 1); do
        ...
        sleep 20
        EXECUTABLE=/users/bbritto/workspace/uFS/cfs/build/test/client-retry/workload/webserver
        $EXECUTABLE -p 1,4,5,6,3 -n $thread -f 2 -r 100 -w 100 -i 4096 -t 2
...
for thread in $(seq 1 5); do
    ...
    for run in $(seq 1 1); do
        ...
        echo "run = {$run} awake"
        EXECUTABLE=/users/bbritto/workspace/uFS/cfs/build/test/client-retry/workload/webserver
        $EXECUTABLE -p 1,4,5,6,3 -n $thread -f 2 -r 100 -w 100 -i 4096 -t 4
...
for thread in $(seq 1 5); do
    ...
    for run in $(seq 1 1); do
        ...
        echo "run = {$run} awake"
        EXECUTABLE=/users/bbritto/workspace/uFS/cfs/build/test/client-retry/workload/webserver
        $EXECUTABLE -p 1,4,5,6,3 -n $thread -f 2 -r 100 -w 100 -i 4096 -t 5
